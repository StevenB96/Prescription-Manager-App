...
def prescription_create(request):
    if request.method == 'POST':
        ...
        return redirect(reverse('prescription_lifecycle_app:prescription-list'))
    ...
    return render(request, 'prescription_lifecycle_app/prescription/form.html', {
        ...
        'submit_label': 'Create',
        'list_url': reverse('prescription_lifecycle_app:prescription-list'),
    })
...
def prescription_detail(request, prescription_id):
    ...
    return render(request, 'prescription_lifecycle_app/prescription/detail.html', {
...
def prescription_delete(request, prescription_id):
    ...
    return render(request, 'prescription_lifecycle_app/prescription/confirm_delete.html', {
        'prescription': prescription
    })