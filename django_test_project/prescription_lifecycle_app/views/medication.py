...
def medication_list(request):
    ...
    return render(
        request,
        'prescription_lifecycle_app/medication/list.html',
...
def medication_create(request):
    if request.method == 'POST':
        ...
        return redirect(reverse('prescription_lifecycle_app:medication-list'))
    ...
    return render(request, 'prescription_lifecycle_app/medication/form.html', {
        'form': form_data,
...
def medication_detail(request, medication_id):
    ...
    return render(
        request,
        'prescription_lifecycle_app/medication/detail.html',
...
def medication_delete(request, medication_id):
    ...
    return render(
        request,
        'prescription_lifecycle_app/medication/confirm_delete.html',
        {'medication': medication}
    )
