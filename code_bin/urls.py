...
urlpatterns = [
    ...
    path('facilities/<str:facility_id>/',
         views.facility_detail, name='facility-detail'),
    path('facilities/<str:facility_id>/edit/',
         views.facility_update, name='facility-update'),
    path('facilities/<str:facility_id>/delete/',
    ...
    path('appointments/<str:appointment_id>/delete/',
